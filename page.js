  ...
  return (
    <div className="min-h-screen bg-[#0f3a2f] text-white">
      ...
      <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-[#0f3a2fa6]">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold leading-none">Building Zone</p>
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h1 className="text-3xl md:text-5xl font-extrabold leading-tight">
              სრული სამშენებლო ეკოსისტემა: მასალები, მიტანა, პროფესიონალი ბრიგადები
            </h1>
            <p className="mt-4 text-[#cfe9df] text-lg">
              Building Zone გთავაზობთ მრავალფეროვან სამშენებლო მასალებს, ადგილზე მიტანას
              და სერთიფიცირებული ხელოსნების მომსახურებას — პროექტის დაწყებიდან ბოლომდე.
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="#categories" className="px-5 py-3 rounded-xl bg-white/10 hover:bg-white/15 border border-white/10">დაათვალიერე კატეგორიები</a>
          ...
          <div className="relative">
            <div className="aspect-[4/3] rounded-3xl bg-gradient-to-br from-[#154c3a] to-[#0b2a21] shadow-xl ring-1 ring-white/10 grid place-items-center p-6">
              <div className="w-full h-full rounded-2xl border-2 border-[#1a523f] grid place-items-center text-center px-6">
                <p className="text-lg text-[#cfe9df]">აქ შეიტანე თქვენი ბანერი/სლაიდერი ან პროდუქტის ფოტოები (ხელოვნური ბალახი, იზოლაცია და ა.შ.)</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="categories" className="max-w-7xl mx-auto px-4 py-14">
        ...
        <p className="text-[#cfe9df] mt-2">შოურუმში ხელმისაწვდომია და ონლაინ შეკვეთით მიტანით.</p>
          ...
          {[
            ...
            <div key={i} className="group rounded-2xl bg-white/5 ring-1 ring-white/10 overflow-hidden hover:translate-y-[-2px] transition">
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-[#b8e0d0] mt-1">საწყობში • მიწოდება საქართველოს მასშტაბით</p>
      ...
      <section id="services" className="bg-[#0b2e24]">
        <div className="max-w-7xl mx-auto px-4 py-14">
          ...
          <div className="grid md:grid-cols-4 gap-5 mt-8">
            {[
              {t:'მიტანა და ლოჯისტიკა', d:'სწრაფი მიტანა თბილისსა და რეგიონებში.'},
              {t:'სამონტაჟო სამუშაოები', d:'კვალიფიციური ბრიგადები და გარანტია.'},
              {t:'სატექნიკო კონსულტაცია', d:'სწორი შერჩევა, მოცულობის დათვლა, ბიუჯეტი.'},
      ...
      <section id="about" className="max-w-7xl mx-auto px-4 py-14">
        <h2 className="text-2xl md:text-3xl font-bold">რატომ Building Zone?</h2>
        <ul className="grid md:grid-cols-2 gap-4 mt-6 text-[#cfe9df]">
          <li className="bg-white/5 p-4 rounded-2xl">ფასი/ხარისხის ოპტიმალური ბალანსი</li>
          <li className="bg-white/5 p-4 rounded-2xl">სერტიფიცირებული მომწოდებლები და ბრენდები</li>
          <li className="bg-white/5 p-4 rounded-2xl">შოურუმი რეალური სანახაობით და კონსულტაციით</li>
          <li className="bg-white/5 p-4 rounded-2xl">ერთი გუნდი – მასალები + მონტაჟი + მხარდაჭერა</li>
        </ul>
      </section>
      ...
      <section id="contact" className="bg-[#0b2e24]">
        <div className="max-w-7xl mx-auto px-4 py-14 grid md:grid-cols-2 gap-8 items-start">
          <div>
            ...
            <p className="text-[#cfe9df] mt-2">მოგვწერეთ Facebook-ზე ან დატოვეთ მოთხოვნა და დაგიკავშირდებით.</p>
            <div className="mt-6 flex gap-3">
              <a href="https://www.facebook.com/BuildingZoneGeorgia" target="_blank" className="px-5 py-3 rounded-xl bg-[#e2b714] text-[#0f3a2f] font-semibold">Facebook მესიჯი</a>
              <a href="mailto:info@buildingzone.ge" className="px-5 py-3 rounded-xl bg-white/10">წერილი</a>
            </div>
          </div>
          <form className="bg-white/5 ring-1 ring-white/10 rounded-2xl p-6 grid gap-4">
            ...
            <button type="button" className="px-5 py-3 rounded-xl bg-[#e2b714] text-[#0f3a2f] font-semibold">გაგზავნა</button>
          </form>
        </div>
      </section>
      ...
      <footer className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 py-8 text-sm text-[#9fd3be] flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <p>ლოკაცია: თბილისი, ხოშარაულის ქ. 29 • @BuildingZoneGeorgia</p>
        </div>
      </footer>
    </div>
  );
